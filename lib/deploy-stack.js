...
class EkkoStack extends cdk.Stack {
  constructor(scope, id, props) {
      ...
      "ekko-server",
      {
        taskImageOptions: {
          ...
          environment: {
            ...
            S3_BUCKET: props.s3.bucketName.toString(),
            PORT: "80",
          },
          enableLogging: true,
        },
    ...
    // console.log(ekkoService.loadBalancer);

    // const apiEndpoint = ekkoService.loadBalancerUrl;
    const s3BucketName = props.s3.bucketName;
    console.log(props.s3.bucketName.toString());
