...
class EkkoStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const ekkoServerContainer = ecs.ContainerImage.fromRegistry("public.ecr.aws/u0n8j4n8/ekko:latest");
    ...
    // add auto-scaling rule for our fargate service (based on CPU)
    autoScalingGroup.scaleOnCpuUtilization('CPUScaling', {
      targetUtilizationPercent: 55,
      policyName: "Ekko-CPU-Scaling-Policy",
      scaleInCooldown: cdk.Duration.seconds(25),
      scaleOutCooldown: cdk.Duration.seconds(25),
    });
    ...
    autoScalingGroup.scaleOnMemoryUtilization('MemoryScaling', {
      ...
      policyName: "Ekko-Memory-Scaling-Policy",
      scaleInCooldown: cdk.Duration.seconds(25),
      scaleOutCooldown: cdk.Duration.seconds(25),
    });
