...
class EkkoStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const ekkoServerContainer = ecs.ContainerImage.fromRegistry("public.ecr.aws/s8v4g8o5/dorey_server_try:latest");
    ...
    // const role = new iam.Role(this, 'grantECSLambdaAccess', {
    //   assumedBy: new iam.ServicePrincipal('ecs.amazonaws.com'),
    //   // custom description if desired
    //   description: 'this role is to grant ECS access to lambdas in this account',
    // });
    ...
    ekkoService.taskDefinition.executionRole.addManagedPolicy(policy);
